...
public class IssueController {
     ...
     */
    @GetMapping("/issues/{owner}/{repo}/{repoId}/{sessionId}")
    public Mono<ResponseEntity<String>> getIssues(@PathVariable String owner, @PathVariable String repo, @PathVariable Long repoId, @PathVariable Long sessionId) {
        return githubAPIIssueService.getIssues(owner, repo, repoId,sessionId)
